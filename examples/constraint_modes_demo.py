...
def demo_constraint_modes():
    ...
    # Create SWC model with varying initial radii
    skeleton = SWCModel()
    skeleton.add_junction(node_id=0, x=0.0, y=0.0, z=0.0, r=0.4)
    skeleton.add_junction(node_id=1, x=0.0, y=0.0, z=5.0, r=0.6)
    skeleton.add_junction(node_id=2, x=0.0, y=0.0, z=10.0, r=0.4)
